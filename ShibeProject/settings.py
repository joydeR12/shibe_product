"""
Django settings for ShibeProject project.
...
SECRET_KEY = 'django-insecure-(t%zhbm%lc6=6t_g9ile%orywi&()99*topa$h+c5p9=(su29&'
...
ROOT_URLCONF = 'ShibeProject.urls'
...
WSGI_APPLICATION = 'ShibeProject.wsgi.application'
